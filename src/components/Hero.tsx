      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <div className={`transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-300 mb-12 leading-relaxed max-w-4xl mx-auto font-light">
          ...
          <div className={`transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <button className="group relative bg-gradient-to-r from-[#ffd504] to-[#e6c004] text-black px-8 sm:px-10 py-4 sm:py-5 rounded-full font-bold text-base sm:text-lg md:text-xl hover:shadow-2xl hover:shadow-[#ffd504]/50 transition-all duration-500 transform hover:scale-110 hover:-translate-y-2 flex items-center gap-3 overflow-hidden">
              ...
              <button className="group relative border-3 border-[#e71c76] text-[#e71c76] px-8 sm:px-10 py-4 sm:py-5 rounded-full font-bold text-base sm:text-lg md:text-xl hover:bg-[#e71c76] hover:text-white transition-all duration-500 transform hover:scale-110 hover:-translate-y-2 flex items-center gap-3 overflow-hidden">
          ...
          <div className={`transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="grid grid-cols-3 gap-8 pt-8">
              <div className="group text-center transform hover:scale-110 transition-all duration-500">
                <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-[#ffd504] to-[#e71c76] bg-clip-text text-transparent mb-3 group-hover:animate-bounce">
                  <CountUp
                    end={25}
                    suffix="+"
                    duration={2.5}
                ...
                <div className="text-gray-400 text-sm sm:text-base md:text-lg font-medium">Years</div>
              </div>
              <div className="group text-center transform hover:scale-110 transition-all duration-500">
